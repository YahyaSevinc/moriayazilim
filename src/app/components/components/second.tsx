...
export default function SecondMain({ isVisible, displayedText }: SecondMainProps) {
    return (
        <div className="text-center mx-auto mb-4">
            {/* LCP Öğesi (h1): Animasyon ve opacity-0 TAMAMEN KALDIRILDI. Anında yüklenecek! */}
            <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
                Dijital iş süreçlerinizi
                <br />
                {/* Daktilo Efekti: h-20 vb. ile sabit bir yükseklik verdik ki kelime uzunlukları değiştikçe sayfa zıplamasın (Reflow hatasını çözer) */}
            ...
            {/* Paragraf ve Buton animasyonları kalabilir, LCP'yi etkilemezler */}
