...
export default function BlogsPage() {
  ...
  const filteredBlogs =
    selectedCategory === "all" ? blogs : blogs.filter((blog) => blog.categoryId === selectedCategory);
              ...
              >
                ...
                <div className="p-6 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed line-clamp-3">{blog.desc}</p>
                  </div>
                </div>
              </Link>
            );
